...
BOARD_MKBOOTIMG_ARGS := --kernel_offset 0x00008000 --ramdisk_offset 0x01000000 --tags_offset 0x00000100 --dt device/samsung/j4lte/dtb.img --board SRPRB08A006RU # --dt $(OUT_DIR)/target/product/j4lte/obj/KERNEL_OBJ/arch/$(TARGET_ARCH)/boot/dtb.img
